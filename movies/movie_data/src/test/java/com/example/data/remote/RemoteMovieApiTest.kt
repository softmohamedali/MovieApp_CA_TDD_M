...
class RemoteMovieApiTest {
    ...
    private val remoteMovieApi by lazy {
        retrofit.create(RemoteMovieApi::class.java)
    }

    private val testPopularMovieJson="""{
  "page": 1,
  "results": [
    {
      "poster_path": null,
  ...
  "total_pages": 4
    ...
    fun getPopularMovie()= runTest{
        ...
        assertThat(testObserver.body()).isEqualTo(testPopularMovieJson)
    }
}